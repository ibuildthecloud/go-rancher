...
type Port struct {
    ...
    PrivatePort int `json:"privatePort,omitempty",yaml:"private_port,omitempty"`
    
    Protocol string `json:"protocol,omitempty",yaml:"protocol,omitempty"`
    
    PublicIpAddressId string `json:"publicIpAddressId,omitempty",yaml:"public_ip_address_id,omitempty"`
    
    PublicPort int `json:"publicPort,omitempty",yaml:"public_port,omitempty"`
    ...
    TransitioningProgress int `json:"transitioningProgress,omitempty",yaml:"transitioning_progress,omitempty"`
