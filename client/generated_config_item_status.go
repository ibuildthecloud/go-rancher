...
type ConfigItemStatus struct {
    ...
    AppliedVersion int `json:"appliedVersion,omitempty",yaml:"applied_version,omitempty"`
    
    Name string `json:"name,omitempty",yaml:"name,omitempty"`
    
    RequestedUpdated string `json:"requestedUpdated,omitempty",yaml:"requested_updated,omitempty"`
    
    RequestedVersion int `json:"requestedVersion,omitempty",yaml:"requested_version,omitempty"`
